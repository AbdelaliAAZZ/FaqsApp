          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 md:p-8 transition-colors duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="form-group">
                <label htmlFor="name" className="form-label dark:text-gray-200">Your Name</label>
                <input
                  type="text"
                  id="name"
                  name="name"
                  ...
                  className={`form-control dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 ${errors.name ? 'border-red-500 dark:border-red-500' : ''}`}
              ...
              <div className="form-group">
                <label htmlFor="email" className="form-label dark:text-gray-200">Email Address</label>
                <input
                  type="email"
                  id="email"
                  name="email"
                  ...
                  onChange={handleChange}
                  className={`form-control dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 ${errors.email ? 'border-red-500 dark:border-red-500' : ''}`}
              ...
              {activeMethod === 'whatsapp' && (
                <div className="form-group">
                  <label htmlFor="phone" className="form-label dark:text-gray-200">WhatsApp Number</label>
                  <input
                    type="tel"
                    id="phone"
                    name="phone"
                    ...
                    onChange={handleChange}
                    className={`form-control dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 ${errors.phone ? 'border-red-500 dark:border-red-500' : ''}`}
              ...
              <div className="form-group">
                <label htmlFor="message" className="form-label dark:text-gray-200">Your Message</label>
                <textarea
                  id="message"
                  name="message"
                  value={formData.message}
                  onChange={handleChange}
                  className={`form-control h-32 resize-none dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 ${errors.message ? 'border-red-500 dark:border-red-500' : ''}`}
